...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"formatInput.js":[function(require,module,exports) {
"use strict";
...
require("./styles.css");
var _formatInput = _interopRequireDefault(require("./formatInput.js"));
...
function onKeyDown(event) {
  ...
  if (/\d/.test(event.key) || event.key === "Backspace" || event.key.contains("Arrow")) {
    return true;
  } else {
...
function onInput(event) {
  // get previous caret
  var prevCaret = event.currentTarget.selectionStart;
  var formattedInput = (0, _formatInput.default)(event.currentTarget.value);
...
},{"./styles.css":"styles.css","./formatInput.js":"formatInput.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/sandbox.e31bb0bc.js.map